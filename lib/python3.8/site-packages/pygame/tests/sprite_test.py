...
class LayeredGroupBase:
    def test_get_layer_of_sprite(self):
        expected_layer = 666
        spr = self.sprite()
        self.LG.data(spr, layer=expected_layer)
    ...
    def test_add__spritelist_passing_layer(self):
        ...
        self.LG.data(sprites, layer=expected_layer)
    ...
    def test_add__layers_are_correct(self):
        ...
        for lay in layers:
            self.LG.data(self.sprite(), layer=lay)
        layers.sort()
    ...
    def test_get_top_layer(self):
        ...
        for i in layers:
            self.LG.data(self.sprite(), layer=i)
