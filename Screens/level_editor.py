...
class Screen:
    ...
    def draw(self):
        ...
        # background_width = pygame.image.load('Images/Background/sky_solid_color.png', (0, 0))
        # print(background_width)

        for image in test_screen.images:
            self.screen_display.blit(pygame.image.load(image.get('source')),
                                     (image.get('position_x'), image.get('position_y')))
...
test_screen = Screen(SCREEN_WIDTH + SIDE_MARGIN, SCREEN_HEIGHT + LOWER_MARGIN)

test_screen.add_images('Images/Background/sky_solid_color.png', 0, 0) # first screen/ background
test_screen.add_images('Images/Background/mountain_depth_z_1.png', 0, 140)
test_screen.add_images('Images/Background/mountain_depth_z_2.png', 0, 290)
